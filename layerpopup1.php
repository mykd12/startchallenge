...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
	<div class="layerpopup popup_div<?=$pop_idx?>" id='_hidden_layer_<?=$pop_idx?>'>
		<div class="layerpopup-container" id="pop-layer-<?=$pop_idx?>" >
			...
			<div class="content">
				<?if(preg_match($mobile_agent, $_SERVER['HTTP_USER_AGENT'])){?>
					<img src="<?=$IMG?>" alt="image" style="max-width:100%; cursor: pointer;" onclick="location.href='http://startchallenge.co.kr/notice_view.php?mode=NOVIEW&NOT_IDX=9&type=&pageNo=1';">
				<?}else{?>
					<img src="<?=$IMG?>" alt="image" style="cursor: pointer;" onclick="location.href='http://startchallenge.co.kr/notice_view.php?mode=NOVIEW&NOT_IDX=9&type=&pageNo=1';">
				<?}?>
			</div>
