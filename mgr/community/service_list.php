            ...
            <ul class="u-list-inline g-color-gray-dark-v6 add-location">
              ...
              <li class="list-inline-item g-mr-10">
                ...
                <i class="hs-admin-angle-right g-font-size-12 g-color-gray-light-v6 g-valign-middle g-ml-10"></i>
							...
							<li class="list-inline-item g-mr-10">
                <a class="u-link-v5 g-color-gray-dark-v6 g-color-lightblue-v3--hover g-valign-middle" href="#!">서비스 가이드 리스트</a>
              </li>
          ...
          <div class="g-pa-20 CTs-list-notice m---style01" id="CTs-list">
            ...
            <div class="media">
              <div class="d-flex align-self-center">
                <h1 class="g-font-weight-300 g-font-size-25 g-color-black mb-0 page-big-title">서비스 가이드 리스트</h1>
              </div>
              <div class="media-body align-self-center text-right">
                <a class=" btn btn u-btn-primary g-width-100--md g-font-size-default g-ml-10" href="service_write.php?mode=SINSERT&pageNo=<?=$pageNo?>&search=<?=$search?>">+ 글쓰기
              </a>
              </div>
            </div>
            ...
            <div class="media-md align-items-center g-mb-30">
              <div class="media d-md-flex align-items-center ml-auto">
                <div class="d-flex g-ml-15 g-ml-55--md">
									<form action='service_list.php' method='get' id='frm' name='frm'>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class='table_title'>
												<a href='service_write.php?mode=SMODIFY&SVT_IDX=<?=$row['SVT_IDX']?>&pageNo=<?=$pageNo?>&search=<?=$search?>' class="g-color-black"><?=$row['SVT_QUESTION']?></a>
											</td>
                      <td><?=$row['SVT_REG_DATE']?></td>
                      <td class="text-right" >
												<a href="service_write.php?mode=SMODIFY&SVT_IDX=<?=$row['SVT_IDX']?>&pageNo=<?=$pageNo?>&search=<?=$search?>" class="btn btn-xs u-btn-indigo g-mr-10 ">
													<i class="hs-admin-pencil g-mr-3"></i>
													수정
												</a>
												<a href="../inc/adminDAO.php?mode=SDELETE&SVT_IDX=<?=$row['SVT_IDX']?>&pageNo=<?=$pageNo?>&search=<?=$search?>" class="btn btn-xs u-btn-primary g-mr-10 " onclick="return confirm('삭제하시겠습니까?');">
