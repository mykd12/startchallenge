							...
							<div class="row">
								...
								<div class="g-brd-around g-brd-gray-light-v7 g-pa-15 g-pa-20--md g-mb-30 add-write-page">
									...
									<div class="row">
										...
										<div class="form-group g-mb-20 col-md-12 CPT_CATE2_1_DIV" <?if($mode=='CPMODIFY' && ($CPT_CATE2=='제품' || $CPT_CATE2=='지역')){}else{ echo "style='display:none'"; }?>>
											<div class="g-mb-20">
												<label class="form-check-inline u-check g-pl-25">
													<input class="g-hidden-xs-up g-pos-abs g-top-0 g-left-0" type="checkbox" name="CPT_CATE2_1" id="CPT_CATE2_1" <?if($CPT_CATE2_1 =='페이백'){ echo " checked"; }?> value="페이백">
										...
										<?}else if($mode=='CPMODIFY' && !$CPT_KEYWORD){?>
											<div class="form-group g-mb-20 col-md-12">
												<h4 class="h6 g-font-weight-600 g-color-black g-mb-10">키워드
													<a href="javascript:add_key();" class="btn btn-xs u-btn-outline-primary  g-ml-15 g-mb-5"><i class="fa fa-plus"></i></a>
													<a href="javascript:del_key();" class="btn btn-xs u-btn-outline-darkgray g-mb-5"><i class="fa fa-minus"></i></a>
												</h4>
												<?while($row_ckt = mysqli_fetch_array($result_ckt)){ // 반복문?>
												<input type="hidden" name="CKT_IDX[]" id="CKT_IDX<?=$row_ckt['CKT_IDX']?>" value="<?=$row_ckt['CKT_IDX']?>" />
													<input type="hidden" name="CKT_UPDATE[]" id="CKT_UPDATE<?=$row_ckt['CKT_IDX']?>" value="" />
													<div class='col-md-12'>
														<div class="row" id='div_<?=$row_ckt['CKT_IDX']?>'>
															<div class="col-md-1">
																<a href="javascript:key_del('<?=$row_ckt['CKT_IDX']?>');" class="btn btn-lg u-btn-primary g-mr-10 g-mb-15">
																	<i class="hs-admin-trash"></i>
																</a>
															</div>
															<div class="col-md-11">
																<input  class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 g-mb-10" name='CKT_KEYWORD_UPDATE[]' id='CKT_KEYWORD_UPDATE' type="text" placeholder='키워드를 입력 해주세요.' value="<?=$row_ckt['CKT_KEY_WORD']?>">
															</div>
														</div>
													</div>
												<?}?>
										...
										<?}else{?>
											<div class="form-group g-mb-20 col-md-12">
												...
												<div id='key_div'>
													<input  class="form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14" name='CKT_KEYWORD[]' id='CKT_KEYWORD' type="text" placeholder='키워드를 입력 해주세요.' autocomplete='off'/>
												</div>
											</div>
										<?}?>
										<div class="form-group g-mb-20 col-md-12">
										...
										<div class="form-group g-mb-20 col-md-12">
											...
											<textarea  class="form-control " name='CPT_NOTICE' id='CPT_NOTICE' placeholder='캠페인 안내사항을 입력 해주세요.' autocomplete='off'>
												<?if($mode=='CPMODIFY'){?>
													<?=$CPT_NOTICE?>
												<?}else{?>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														※ 리뷰 등록 및 방문이 어려울 경우 카톡(start0202) 또는 1:1문의로 사전에 연락 주세요.
													</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														※ 배송 (제품) 캠페인은 선정 이후 단순 변심(개인 사정)으로 인한 제품 변경/반품/환불 불가능합니다.
													</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														※ 스타트체험단 : 070-8633-8941(월-금 10am-17pm) / 토·일·공휴일 휴무
													</p>
													<p>&nbsp;​&nbsp;</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														1. 리뷰 게시글 하단에는 체험 제공 스폰서 배너 이미지를 등록해주세요.
													</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														- 공정위문구는 공정거래위원회에서 요청하는 의무사항입니다. 공정위문구 미 기재시 표시광고법위반으로 처벌받을 수 있습니다.
													</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														2. 등록한 리뷰 및 이미지는 광고주에 의해 활용될 수 있습니다.
													</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														3. 정당한 사유 없이 등록 기간 내 리뷰를 작성하지 않을 경우 관련 법 조항 (형법 제347조)에 따라 법적 처벌 대상이 될 수 있습니다.
													</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														4. 등록된 콘텐츠는 6개월 이상 유지해야하며, 미유지 시 패널티가 부과됩니다.
													</p>
													<p style="font-family: 'Noto Sans KR','돋움',Dotum,'Helvetica Neue','Apple SD Gothic Neo',sans-serif;">
														5. 업체 사정으로 인해 모집 기간 및 인원은 추후 변경될 수 있습니다.&nbsp; &nbsp;
													</p>
													<p>&nbsp;​&nbsp;</p>
													<p><img src="//startchallenge.co.kr/img/bannerA.png"></p>
...
//-->
	...
	<script>
		...
		function add_key(){
			var add_key_input ="<input  class=\"form-control form-control-md g-brd-gray-light-v7 g-brd-gray-light-v3--focus g-rounded-4 g-px-14 add_key g-mt-5\" name='CKT_KEYWORD[]' id='CKT_KEYWORD' type=\"text\" placeholder='키워드를 입력 해주세요.'>";
			$("#key_div").append(add_key_input);
		}

		function del_key(){
			$(".add_key").last().remove();
		}
		function key_del(CKT_IDX){
			$("#CKT_UPDATE"+CKT_IDX).val('del');
			$("#div_"+CKT_IDX).css('display','none');
		}
	</script>
  ...
  $( function() {
	...
	<script>
										var CPT_CATE2 = "<?=$CPT_CATE2?>";
										if(CPT_CATE2=='제품' || CPT_CATE2=='지역'){
											$("#CPT_CATE2_1_DIV").css("display","");
										}
										$('input[name="CPT_CATE2"]').change(function() {
											//console.log($('input[name="CPT_CATE2"]:checked').val());
											if($('input[name="CPT_CATE2"]:checked').val()=='제품' || $('input[name="CPT_CATE2"]:checked').val()=='지역'){
												$(".CPT_CATE2_1_DIV").css("display","");
											}else{
												$("#CPT_CATE2_1").prop('checked', false);
												$(".CPT_CATE2_1_DIV").css("display","none");
											}
										});
										</script>